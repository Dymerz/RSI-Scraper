...
class StarmapTunnels(ICommand):
	...
	def __init__(self, tid: str = None):
		...
		Args:
			tid (str, optional): The tunnel identifier (tid). Defaults to None.
		"""
		self.tid = tid
...
class StarmapSpecies(ICommand):
	...
	def __init__(self, name: str = None):
		"""
		Args:
			name (str, optional): The name of the specie. Defaults to None.
		"""
		self.name = name
...
class StarmapAffiliations(ICommand):
	...
	def __init__(self, name: str = None):
		"""
		Args:
			name (str, optional): The name of the affiliation. Defaults to None.
		"""
		self.name = name
