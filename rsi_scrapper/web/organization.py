...
class Organization(ICommand):
	...
	def execute(self):
		...
		t0 = Thread(target=lambda q, arg1: q.put(self.get_organization_info(arg1)), args=(que, self.sid))
		t0.start()
		threads.append(t0)

		t1 = Thread(target=lambda q, arg1: q.put(self.search_orgs(arg1)), args=(que, self.sid))
		t1.start()
		threads.append(t1)
